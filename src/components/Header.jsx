...
const Header = () => {
	...
	return (
		<header
			className={`flex items-center justify-between fixed inset-0 h-[6rem] xl:h-[7rem] 2xl:h-[9rem] border-b-[1px] 2xl:border-b-[1.5px] border-solid border-[var(--header-border)] px-[4rem] xl:px-[4.5rem] 2xl:px-[5.5rem] transition-all duration-300 bg-white z-[10] ${
